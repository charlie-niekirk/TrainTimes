...
class StationTimelineAdapter(
    ...
    private lateinit var greyColor: ColorFilter
    ...
    override fun onCreateViewHolder(
        ...
        greyColor = PorterDuffColorFilter(
            parent.resources.getColor(R.color.colorSidelineTrans, null), PorterDuff.Mode.SRC_IN
        )
    ...
    override fun onBindViewHolder(
        ...
        if (!callingPoints[position].estimatedTime.isNullOrEmpty()) {
            ...
            holder.stationStatus.text = callingPoints[position].actualTime
        ...
        if (position <= currentIndex) {
            ...
            // Make grey
            holder.sideLine.setBackgroundColor(holder.itemView.resources.getColor(R.color.colorSidelineTrans, null))
            holder.stationIndicator.background.colorFilter = greyColor
        }
    }
